...
export default function LoginForm({ siteName, logoUrl }: { siteName: string; logoUrl: string | null }) {
  ...
  return (
    <div className="grid min-h-screen place-items-center px-4">
      <div className="w-full max-w-sm">
        {logoUrl ? <img src={logoUrl} alt={siteName} className="mb-2 h-8 w-auto" /> : <div className="eyebrow mb-1">{siteName}</div>}
